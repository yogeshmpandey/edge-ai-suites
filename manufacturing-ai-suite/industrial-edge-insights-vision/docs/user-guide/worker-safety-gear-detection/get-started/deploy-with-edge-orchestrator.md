...
3. After you have imported the deployment package into Edge Orchestrator, you can see it in the list of deployment packages:
   ...
   **![WSGD Image](../_assets/wsgd-dp.png)**
...
3. On the Setup a Deployment page, select the **wsgd** package for the deployment from the list, and click **Next**. The Select a Profile step appears.
...
1. Follow the steps in the **Worker Safety Gear Detection** [Documentation](./deploy-with-helm.md#deploy-the-application) on the usage of the application.
