...
3. On the Setup a Deployment page, select the **pcb** package for the deployment from the list, and click **Next**. The Select a Profile step appears.
...
2. Follow the steps in the **PCB Anomaly Detection** [Documentation](./deploy-with-helm.md#deploy-the-application) on the usage of the application.
