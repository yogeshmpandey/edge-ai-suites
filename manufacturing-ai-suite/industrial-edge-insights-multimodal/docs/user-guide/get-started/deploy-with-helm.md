...
- To download the Helm charts:
  ...
  1. Download Helm chart with the following command:
     ...
     ```bash
     helm pull oci://registry-1.docker.io/intel/multimodal-weld-defect-detection-sample-app --version 2026.0.0-rc1
     ```

  2. Unzip the package using the following command:

     ```bash
     tar -xvzf multimodal-weld-defect-detection-sample-app-2026.0.0-rc1.tgz
     ```
