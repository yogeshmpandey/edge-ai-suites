...
|---|---|---|---|
| Copilot (`claude-opus-4.8`) | 1 / 5 | 3 / 5 | **+2 ↑** |

### Pass rate (avg ± σ across evals)

| Agent | w/o skill | w/ skill | Lift |
|---|---|---|---|
| Copilot (`claude-opus-4.8`) | 60% ±31% | 82% ±25% | **+22pp ↑** |
...
| 2 | Build a PPE-compliance stack in ./ppe-compliance-stack/ for hardhat detection ... | FAIL (3/5) | FAIL (1/5) |
| 3 | Build a smart-parking occupancy stack in ./smart-parking-stack/ for vehicle de... | FAIL (2/4) | FAIL (2/4) |
