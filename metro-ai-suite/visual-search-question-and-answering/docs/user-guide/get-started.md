...
2. Set up environment variables.
   ...
   - **Ubuntu**:
     ...
     > [Supported models](https://github.com/open-edge-platform/edge-ai-libraries/blob/2026.1/microservices/vlm-openvino-serving/docs/user-guide/Overview.md#models-supported) for VLM OpenVINO for available VLM models.
