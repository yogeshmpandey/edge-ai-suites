...
[VLM Serving Documentation](https://github.com/open-edge-platform/edge-ai-libraries/blob/2026.1/microservices/vlm-openvino-serving/docs/user-guide/get-started.md)
