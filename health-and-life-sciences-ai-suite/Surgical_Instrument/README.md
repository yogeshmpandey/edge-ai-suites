...
> ```
>
> Full rationale + verification snippet: [docs/user-guide/get-started.md §2.2](docs/user-guide/get-started.md#22-optional-pre-train-and-export-model-before-make-up).
