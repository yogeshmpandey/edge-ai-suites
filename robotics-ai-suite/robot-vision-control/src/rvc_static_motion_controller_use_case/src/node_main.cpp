...
int main(int argc, char ** argv)
{
    ...
    {
        std::cerr << e.what() << '\n';
        RCLCPP_FATAL(rclcpp::get_logger("node_main"), "Invalid mandatory parameters: MC and/or Grasp plugin");
        return -1;
    }
    ...
    try
    {
        ...
        {
            RCLCPP_INFO(stateMachine->get_logger(), " MC %s failed to init!!!", motionControllerName.c_str());
            return 1;
        }
