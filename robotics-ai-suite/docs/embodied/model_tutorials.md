...
| MobileSAM     | Lightweight substitute to SAM (Same model architecture as SAM. See OpenVINO SAM tutorials for model export and application) | [MobileSAM](https://github.com/openvinotoolkit/openvino_notebooks/tree/latest/notebooks/grounded-segment-anything)                                                       |
...
| FunASR        | Automatic speech recognition                                                                                                | [FunASR Setup in LLM Robotics - sample pipeline](sample_pipelines/llm_robotics.md#funasr-setup)                                                                          |
