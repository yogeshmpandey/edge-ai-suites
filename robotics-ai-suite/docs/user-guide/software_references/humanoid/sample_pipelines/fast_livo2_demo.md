...
The following [scripts](https://github.com/open-edge-platform/edge-ai-suites/tree/release-2026.2.0/robotics-ai-suite/pipelines/fast-livo2-demo/scripts) automate the one-time host prerequisites and repository-specific setup:
...
[scripts/install_deps.sh](https://github.com/open-edge-platform/edge-ai-suites/blob/release-2026.2.0/robotics-ai-suite/pipelines/fast-livo2-demo/scripts/install_deps.sh) installs the required system packages, Livox-SDK2, Sophus, and vikit_common; run it once (needs sudo, safe to re-run):
