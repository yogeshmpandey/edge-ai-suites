...
public:
    ...
    mutual_reproj_edge_wapper(T* shot1, unsigned int idx1, data::landmark* lm1, T* shot2, unsigned int idx2,
...
template <typename T>
mutual_reproj_edge_wapper<T>::mutual_reproj_edge_wapper(T* shot1, unsigned int idx1, data::landmark* lm1, T* shot2,
                                                        unsigned int idx2, data::landmark* lm2,
                                                        g2o::sim3::transform_vertex* Sim3_12_vtx,
