...
public:
    ...
    reproj_edge_wrapper(T* shot, shot_vertex* shot_vtx, data::landmark* lm, landmark_vertex* lm_vtx,
...
template <typename T>
reproj_edge_wrapper<T>::reproj_edge_wrapper(T* shot, shot_vertex* shot_vtx, data::landmark* lm, landmark_vertex* lm_vtx,
