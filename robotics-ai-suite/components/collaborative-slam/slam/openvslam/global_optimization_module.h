...
public:
    //! Constructor
    global_optimization_module(data::map_database* map_db, data::bow_database* bow_db, data::bow_vocabulary* bow_vocab,
                               const bool fix_scale, double front_rear_camera_constraint_thr, int iteration_times, bool segment_optimize);
...
protected:
    ...
    void transform_map_via_sim3(module::keyframe_Sim3_pairs_t& Sim3s_nw_before_correction,
    ...
    void correct_covisibility_keyframes(const module::keyframe_Sim3_pairs_t& Sim3s_nw_after_correction,
    ...
    void transform_map_via_sim3(data::keyframe* keyframe_to_be_transformed, g2o::Sim3 T_sim3,
    ...
    std::vector<data::keyframe*> get_keyframe_local_map(data::keyframe* keyframe, size_t numTemporalKFs = -1);
