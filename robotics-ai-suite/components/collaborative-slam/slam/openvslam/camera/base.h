...
public:
    ...
    base(const std::string& name, const setup_type_t setup_type, const model_type_t model_type,
         const color_order_t color_order, const unsigned int cols, const unsigned int rows, const double fps,
         const double focal_x_baseline, const double true_baseline, const unsigned int num_grid_cols = 64,
    ...
    virtual bool reproject_to_image(const Mat33_t& rot_cw, const Vec3_t& trans_cw, const Vec3_t& pos_w, Vec2_t& reproj,
                                    float& x_right) const = 0;

    virtual bool reproject_to_image_bound(const Mat33_t& rot_cw, const Vec3_t& trans_cw, const Vec3_t& pos_w, Vec2_t& reproj,
