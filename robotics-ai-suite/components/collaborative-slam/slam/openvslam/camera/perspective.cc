...
perspective::perspective(const YAML::Node& yaml_node)
    : perspective(yaml_node["Camera.name"].as<std::string>(), load_setup_type(yaml_node), load_color_order(yaml_node),
                  ...
                  yaml_node["Camera.k2"].as<double>(), yaml_node["Camera.p1"].as<double>(),
                  yaml_node["Camera.p2"].as<double>(), yaml_node["Camera.k3"].as<double>(),
...
bool perspective::reproject_to_image(const Mat33_t& rot_cw, const Vec3_t& trans_cw, const Vec3_t& pos_w, Vec2_t& reproj,
                                     float& x_right) const
{
...
bool perspective::reproject_to_image_bound(const Mat33_t& rot_cw, const Vec3_t& trans_cw, const Vec3_t& pos_w, Vec2_t& reproj,
