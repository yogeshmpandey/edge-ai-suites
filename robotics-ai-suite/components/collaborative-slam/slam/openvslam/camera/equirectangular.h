...
public:
    equirectangular(const std::string& name, const color_order_t& color_order, const unsigned int cols,
    ...
    cv::KeyPoint undistort_keypoint(const cv::KeyPoint& distorted) const override final { return distorted; }
    ...
    bool reproject_to_image_bound(const Mat33_t& rot_cw, const Vec3_t& trans_cw, const Vec3_t& pos_w, Vec2_t& reproj,
    ...
    void set_cv_cam_matrix([[maybe_unused]] float fx, [[maybe_unused]] float fy, [[maybe_unused]] float cx,
