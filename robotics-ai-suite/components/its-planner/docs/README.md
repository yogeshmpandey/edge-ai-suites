...
For customization options, see [ITS Path Planner Plugin Customization](https://docs.openedgeplatform.intel.com/2026.2/edge-ai-suites/robotics-ai-suite/components/optimized_solutions/its-path-planner-plugin.html#its-path-planner-plugin-customization)
