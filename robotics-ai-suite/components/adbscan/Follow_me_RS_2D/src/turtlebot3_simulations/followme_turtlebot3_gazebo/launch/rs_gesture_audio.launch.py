...
"""Terminal 2 — Perception nodes for RealSense follow-me with gesture + audio.

Launches:
    • ADBSCAN node (RealSense / depth-camera config subscribing to /camera/points)
...
def generate_launch_description():
    ...
    # ADBSCAN node — RealSense / depth-camera mode
