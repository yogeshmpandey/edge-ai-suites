...
"""Terminal 2 — Perception nodes for LiDAR follow-me with gesture (no audio).

Launches:
    • ADBSCAN node (2D LiDAR config, gesture only)
...
def generate_launch_description():
    ...
    # ADBSCAN node — 2D LiDAR, gesture only (no audio)
