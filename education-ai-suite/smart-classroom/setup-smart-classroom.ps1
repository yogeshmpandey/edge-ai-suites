...
$systemRequirementsDocUrl = "https://github.com/open-edge-platform/edge-ai-suites/blob/release-2026.2.0/education-ai-suite/smart-classroom/docs/user-guide/get-started/system-requirements.md#software-and-hardware-requirements"
...
if ($diarizationWasEnabled -and -not (Test-HfTokenSet -Content $configContent)) {
    ...
    Write-Host "            https://github.com/open-edge-platform/edge-ai-suites/blob/release-2026.2.0/education-ai-suite/smart-classroom/docs/user-guide/advance-setup-guide.md#f-speaker-diarization-setup-optional" -ForegroundColor Red
    Write-Host ""
}
...
if ($diarizationIsEnabled) {
    ...
    if ($diarModelDownloaded) {
        ...
        Write-Host "         https://github.com/open-edge-platform/edge-ai-suites/blob/release-2026.2.0/education-ai-suite/smart-classroom/docs/user-guide/advance-setup-guide.md#f-speaker-diarization-setup-optional" -ForegroundColor Yellow
        Write-Host ""
